...
export default function DocumentsPage() {
  ...
  const handleDownload = () => {
    if (cardRef.current) {
        // If the card is flipped, we flip it back to the front for the screenshot
        const cardElement = cardRef.current.firstChild as HTMLElement;
      ...
      <div className="w-full max-w-lg [perspective:1000px]">
        ...
        >
            <div ref={cardRef}>
                ...
                {/* Card Back */}
                <div className={cn(
                    "w-full h-full p-6 flex flex-col justify-between text-black absolute [backface-visibility:hidden] [transform:rotateY(180deg)]",
                ...
                >
                    ...
                    <div className="mt-20 flex items-center gap-4">
                        ...
                        <div className="bg-white p-1 rounded-sm">
                            <p className="font-mono text-sm font-semibold">{cvv}</p>
                        </div>
                    </div>
