...
export default function AdminPage() {
    ...
    const { allUsers, addUser, adminWalletBalance } = useUser()
        ...
        <div className="flex flex-col gap-8">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <Card>
                 ...
                 <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle className="text-sm font-medium">Frais Collectés (Admin)</CardTitle>
                        <Landmark className="h-4 w-4 text-muted-foreground" />
                    </CardHeader>
                    <CardContent>
                        <div className="text-2xl font-bold">{adminWalletBalance.toLocaleString('fr-FR', { style: 'currency', currency: 'USD' }).replace('USD', 'BZD').replace(',', '.')}</div>
                         <p className="text-xs text-muted-foreground">
                            Total des frais de transaction perçus
                        </p>
                    </CardContent>
                </Card>
            </div>
